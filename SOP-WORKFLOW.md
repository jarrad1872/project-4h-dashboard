...
- Business card print exports for Dustin must use the high-resolution proof-sheet-faithful PNGs in `public/sales-assets/print-hires`, not remade coded layouts or the legacy SVG/PNG route. The current pack is six 2172x1272 full-bleed PNGs plus `dustin-pipe-business-card-print-pack-hires.zip`; the copy, QR, contact info, and demo line are upscaled from the approved generated card crops so Vistaprint preserves the selected creative direction.
