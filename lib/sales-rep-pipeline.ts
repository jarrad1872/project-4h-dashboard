...
export const salesLeads: SalesLead[] = [
  ...
  },
  {
    id: "az-saw-owner-001",
    repId: "rep-az-founding",
    businessName: "Mesa concrete cutting owner target",
    city: "Mesa",
    state: "AZ",
    tradeDomain: "saw.city",
    stage: "qualified",
    leadType: "archetype",
    ownerProfile: "Concrete cutting operator who misses estimate calls while on noisy jobs.",
    painSignal: "High-intent project calls arrive while saws are running and callbacks happen too late.",
    nextAction: "Confirm owner name, then offer a live saw.city estimate-call simulation.",
    lastTouchedAt: null,
    trackingCode: "AZ-S-001",
    notes: "Internal archetype. Replace with a real owner row before marking contacted.",
    createdAt: "2026-04-27T00:00:00.000Z",
    updatedAt: "2026-04-27T00:00:00.000Z",
  },
  ...
  {
    id: "az-rinse-owner-001",
    repId: "rep-az-founding",
    businessName: "Scottsdale pressure washing owner target",
    city: "Scottsdale",
    state: "AZ",
    tradeDomain: "rinse.city",
    stage: "prospect",
    leadType: "archetype",
    ownerProfile: "Owner-led pressure washing shop with estimate calls during active jobs.",
    painSignal: "Driveway, patio, and HOA cleanup leads go cold if the owner waits until evening.",
    nextAction: "Confirm owner name, qualify estimate volume, then plan a first card drop.",
    lastTouchedAt: null,
    trackingCode: "AZ-R-001",
    notes: "Internal archetype. Replace with a real owner row before marking contacted.",
    createdAt: "2026-04-27T00:00:00.000Z",
    updatedAt: "2026-04-27T00:00:00.000Z",
  },
  {
    id: "az-lockout-owner-001",
    repId: "rep-az-founding",
    businessName: "Tempe locksmith owner target",
    city: "Tempe",
    state: "AZ",
    tradeDomain: "lockout.city",
    stage: "qualified",
    leadType: "archetype",
    ownerProfile: "Small locksmith with emergency lockout calls and owner-dispatch pressure.",
    painSignal: "Lockout callers rarely wait; missed calls become someone else's job.",
    nextAction: "Ask for one emergency-call simulation and track whether a demo gets booked.",
    lastTouchedAt: null,
    trackingCode: "AZ-L-001",
    notes: "Internal archetype. Replace with a real owner row before marking contacted.",
    createdAt: "2026-04-27T00:00:00.000Z",
    updatedAt: "2026-04-27T00:00:00.000Z",
  },
