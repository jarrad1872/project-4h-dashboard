...
export const rebuildExecutionQueue: RebuildQueueItem[] = [
  ...
  },
  {
    ...
    status: "ready",
    approval: "none",
    outcome: "Command or Scorecard exposes the useful lifecycle/template signals so direct-link support routes do not need daily sidebar space.",
    acceptance: "The active route shows concise lifecycle/template status and links to support pages without sending outreach, webhooks, or external actions.",
  },
];
