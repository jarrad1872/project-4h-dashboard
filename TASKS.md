...
- [ ] Audit the current creator shortlist and remove weak/non-trade matches.
- [ ] Add creator scoring fields that matter for trades: owner audience, average views, sponsor openness, trust level, trade fit.
...
- [ ] Add creator-specific UTM/referral code generation.
...
- [ ] Archive or label historical ads so they cannot be mistaken for current launch candidates.
...
- [ ] Add a simple forecast: customers needed this month, current pace, gap, and next bets.
...
- [ ] Work through Q-01 through Q-24. Current: Q-01 in progress; production desk is ready, images still need generation/upload.
