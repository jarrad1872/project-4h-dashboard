...
| Q-75 | Field Sales | Print Assets | Add hi-res Dustin Vistaprint files | 2026-04-28 | `/sales` now downloads the actual print artwork: six 2172x1272 high-resolution PNGs plus a ZIP pack, instead of pointing Dustin at proof-sheet crops, background-only files, or legacy mechanical exports. |
