...
- `/sales` now exposes Vistaprint-ready Dustin card files under `public/sales-assets/print-hires`: six 2172x1272 PNGs and a ZIP pack cropped from `public/sales-assets/dustin-pipe-proof-sheet-v2.png`, an imagegen-native proof sheet created from scratch in the approved dark pipe.city style
