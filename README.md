...
- `/sales` now exposes Vistaprint-ready Dustin card files under `public/sales-assets/print`: six flattened 1086x636 PNGs and a ZIP pack cropped from the approved generated proof sheet, so the uploaded card artwork includes the copy, QR, and demo line baked in
